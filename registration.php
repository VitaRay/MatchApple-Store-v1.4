        ...
        <nav class="navbar">
            ...
            <div class="page-name">
                <div class="container" style="border-top: 1px solid rgb(210, 210, 215); justify-content: left;">
                    <a href="registration.html"><h3>Регистрация</h3></a>
                    <img src="images/registration-icon.svg" alt="login-picture" style="height: 35px;margin: auto 10px;">
                </div>
            </div>
        </nav>
        
        <div class="container form-container page-content">
            <main class="form-signin w-100 m-auto mb-5">
                <form action="assets/register-func.php" style="text-align: center;" method="POST">
                    <div class="dp-flx">
                    ...
                    <div class="form-floating">
                        <input required type="text" class="form-control" id="floatingInput" placeholder="Имя пользователя (Логин):" name='login'>
                        <label for="floatingInput">Имя пользователя (Логин):</label>
                    </div>
                    <div class="form-floating">
                        <input required type="email" class="form-control" id="floatingInput" placeholder="E-mail:" name="email">
                        <label for="floatingInput">E-mail:</label>
                    </div>
                    <div class="form-floating">
                        <input required type="password" class="form-control" id="floatingPassword" placeholder="Пароль:" name="pass">
                        <label for="floatingPassword">Пароль:</label>
                    </div>
                    <div class="form-floating">
                        <input required type="password" class="form-control" id="floatingPassword" placeholder="Подтверждение пароля:" name="repeatpass">
                        <label for="floatingPassword">Подтверждение пароля:</label>
                    </div>
                    <div class="form-check text-start my-3">
                        <input required class="form-check-input" type="checkbox" value="remember-me" id="flexCheckDefault">
                        <div class="agreement-block">
                            <p>Я прочёл</p>
                            <a href="#" style="margin: 0 5px; color: #007AFF;">согласие</a>
                            <p> на обработку персональных данных</p>
                        </div>
                    </div>
                    <div class="dp-flx">
                        <button class="action-button registr-button" type="submit">Зарегистрироваться</button>
                    </div>
                    <div class="form-floating">
                        <a href="login.php" style="text-align: center; color: #007AFF;">Уже есть аккаунт? Войдите</a>
                    </div>
                </form>
            </main>
        </div>
